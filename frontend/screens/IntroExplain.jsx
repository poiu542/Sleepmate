    ...
    return(
        ...
        <Animatable.View ref={(ref) => setAnimation12(ref)} style={tw`flex-1 bg-black`}>
            ...
            <View style={tw`flex-1`}>
                ...
                <Animatable.Text ref={(ref) => setAnimation3(ref)} style={sceen===3?tw`absolute top-0 left-0 right-0 bottom-0 text-white text-4.2 font-bold mt-[${height}] text-center`:tw`hidden`}>몇 가지 질문을 드리겠습니다.</Animatable.Text>
                ...
                <Animatable.Text ref={(ref) => setAnimation4(ref)} style={sceen===4?tw`absolute top-0 left-0 right-0 bottom-0 text-white text-4.2 font-bold mt-[${height}] text-center`:tw`hidden`}>평소 몇 시에 일어나세요?</Animatable.Text>
                
                <DropDownTime display={sceen}/>
                <Animatable.Text ref={(ref) => setAnimation6(ref)} style={sceen===6?tw`absolute top-0 left-0 right-0 bottom-0 text-white text-4.2 font-bold mt-[${height}] text-center`:tw`hidden`}>평소 몇 시간 정도 잠을 자시나요?</Animatable.Text>
                ...
                />:null}
                <Animatable.Text ref={(ref) => setAnimation8(ref)} style={sceen===8?tw`absolute top-0 left-0 right-0 bottom-0 text-white text-4.2 leading-7 mt-[${height}] text-center font-bold`:tw`hidden`}>{`키와 몸무게는 어떻게 되시나요?\nBMI검사에 활용됩니다.`}</Animatable.Text>
