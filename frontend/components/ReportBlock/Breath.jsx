        ...
        <View style={tw `flex-1 w-full bg-[#fff]/70 rounded-5 p-3 mb-4`}>
                    ...
                    <View style={tw `flex-1 flex-row`}>
                        <View style={tw `flex-2 `}>
                            <Text style={tw `text-lg text-[#333] text-[4]`}>심박수 안정도</Text>
                        </View>
                    ...
                    <View style={tw `flex-1 items-center`}>
                        <View style={tw `rounded-2 border-[#ddd] border-[0.25] p-1 items-center w-full`}>
                            <Text style={tw `text-[3.2] text-[#333] tracking-tight font-bold leading-5`}>수면 무호흡이 의심될 시 똑바로 누운 자세는 좋지 않습니다.</Text>
                            <Text style={tw `text-[3.2] text-[#333] tracking-tight font-bold`}>옆으로 눕거나 엎드린 자세를 권장드립니다.</Text>
                        </View>
                        <Text style={tw `text-[2.1] mt-1 tracking-tighter`}>* 수면 무호흡증은 심박수 만으로 판단할 수 없습니다. 정확한 진단을 위해 의사를 방문해주세요.</Text>
                    </View>
                </View>
