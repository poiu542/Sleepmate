                ...
                
            {
                ...
                count!==0?motions.map((data, index)=>{
                    ...
                    return(
                        ...
                        data.posture===1?<TouchableOpacity onPress={()=>showModal(1, motions[0].capture, "FW(Forward) 정자세 유형입니다.")} style={tw`w-20 h-20 items-center justify-between mr-5`}><Image style={tw`mr-5 w-full h-45`} source={M_motion_forward} resizeMode="contain"/><Text style={tw`text-white`}>{data.time.split("T")[1]?data.time.split("T")[1].slice(0,8):null}</Text></TouchableOpacity>:(
                            data.posture===2?<TouchableOpacity onPress={()=>showModal(2, motions[1].capture, "BACK 엎드림 유형입니다.")} style={tw`w-20 h-20 items-center justify-between mr-5`}><Image  style={tw`mr-5 w-full h-45`} source={M_motion_reverse} resizeMode="contain"/><Text style={tw`text-white`}>{data.time.split("T")[1]?data.time.split("T")[1].slice(0,8):null}</Text></TouchableOpacity>:(
                                data.posture===3?<TouchableOpacity onPress={()=>showModal(3, motions[2].capture, "UP 만세 유형입니다.")} style={tw`w-20 h-20 items-center justify-between mr-5`}><Image style={tw`mr-5 w-full h-45`} source={M_motion_hands_up} resizeMode="contain"/><Text style={tw`text-white`}>{data.time.split("T")[1]?data.time.split("T")[1].slice(0,8):null}</Text></TouchableOpacity>:(
                                    data.posture===4?<TouchableOpacity onPress={()=>showModal(4, motions[3].capture, "LEFT 왼쪽눕기 유형입니다.")} style={tw`w-20 h-20 items-center justify-between mr-5`}><Image style={tw`mr-5 w-full h-45`} source={M_motion_origin_left} resizeMode="contain"/><Text style={tw`text-white`}>{data.time.split("T")[1]?data.time.split("T")[1].slice(0,8):null}</Text></TouchableOpacity>:(
                                        data.posture===5?<TouchableOpacity onPress={()=>showModal(5, motions[4].capture, "LEFT_S 왼쪽새우 유형입니다.")} style={tw`w-20 h-20 items-center justify-between mr-5`}><Image style={tw`mr-5 w-full h-45`} source={M_motion_shirimp_left} resizeMode="contain"/><Text style={tw`text-white`}>{data.time.split("T")[1]?data.time.split("T")[1].slice(0,8):null}</Text></TouchableOpacity>:(
                                            data.posture===6?<TouchableOpacity onPress={()=>showModal(6, motions[5].capture, "RIGHT 오른쪽눕기 유형입니다.")} style={tw`w-20 h-20 items-center justify-between mr-5`}><Image style={tw`mr-5 w-full h-45`} source={M_motion_origin_right} resizeMode="contain"/><Text style={tw`text-white`}>{data.time.split("T")[1]?data.time.split("T")[1].slice(0,8):null}</Text></TouchableOpacity>:(
                                                data.posture===7?<TouchableOpacity onPress={()=>showModal(7, motions[6].capture, "RIGHT_S 오른쪽새우 유형입니다.")} style={tw`w-20 h-20 items-center justify-between mr-5`}><Image style={tw`mr-5 w-full h-45`} source={M_motion_shirimp_right} resizeMode="contain"/><Text style={tw`text-white`}>{data.time.split("T")[1]?data.time.split("T")[1].slice(0,8):null}</Text></TouchableOpacity>:(
                                                    data.posture===8?<TouchableOpacity onPress={()=>showModal(8, motions[7].capture, "etc 기타 유형입니다.")} style={tw`w-20 h-20 items-center justify-between mr-5`}><Image style={tw`mr-5 w-full h-45`} source={questionMark} resizeMode="contain"/><Text style={tw`text-white`}>{data.time.split("T")[1].slice(0,8)}</Text></TouchableOpacity>:(
                                                        data.posture===9?<TouchableOpacity onPress={()=>showModal(9, motions[8].capture, "X 없음 유형입니다.")} style={tw`w-20 h-20 items-center justify-between mr-5`}><Image style={tw`mr-5 w-full h-45`} source={cancel} resizeMode="contain"/><Text style={tw`text-white`}>{data.time.split("T")[1]?data.time.split("T")[1].slice(0,9):null}</Text></TouchableOpacity>:null
                                                    )
                                                )
                                            )
                                        )
